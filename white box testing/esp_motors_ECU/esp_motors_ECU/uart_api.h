...
------------------------------------------------------------------------------*/
extern void uart_write (unint8_t uart_no, unint8_t a_data);
...
------------------------------------------------------------------------------*/
extern unint8_t uart_read (unint8_t uart_no);
...
[out] -unint8_t * ap_str
	...
	will be received
-----------------------------------------------------------------------------*/
void uart_receive (unint8_t a_uart_no, unint8_t * ap_str,
                                     unint8_t a_str_size);
...
-----------------------------------------------------------------------------*/								  
extern void uart_receive_until (unint8_t a_uart_no, unint8_t * ap_str, 
                                     unint8_t a_mark);
...
[in] -uint8_t a_size
	...
	of the string(number of characters that will be sent).
----------------------------------------------------------------------------*/
extern void uart_send (unint8_t uart_no, const unint8_t * ap_str,
                                      unint8_t a_size);
...
-----------------------------------------------------------------------------*/
extern void uart_send_until (unint8_t uart_no, const unint8_t * str, unint8_t mark);
