...
#define FALSE 0
#define TRUE 1
#define TICK_TIME_1024_PRESCALER (( (unint32_t)1024 * 1000000 / F_CPU)) //the time between each timer clock tick and the next one in microseconds (the same meaning as the time of 1024 cycles in microseconds because we are choosing 1024 prescaler)
