/* ---------------------------------------------------------------------------------------------------
[FILE NAME]: lcd_4bit.h
[AUTHOR(S)]: Ali Makhlouf
[DATE CREATED]: 1/6/2016
[DESCRIPTION]: library header file for LCD with maximum 4 raws
--------------------------------------------------------------------------------------------------- */
...
[Description] : This function is responsible for initialising the LCD doing these steps:
				1-setting the LCD pins high as well as the control pins
				2-initialising it's cursor and screen and setting it in 4-bit mode
				3-show the cursor
---------------------------------------------------------------------------------------------------------------*/
void LCD_init();
