...
void uart_send_until(unint8_t a_uart_no, const void * ap_str, unint16_t a_mark)
{
	//used for accessing string elements one by one 
	unint8_t count = 0;
...
void uart_send_str(unint8_t a_uart_no, const void * ap_str)
{
	 uart_send_until(a_uart_no, ap_str, 0);
...
void uart_read(unint8_t a_uart_no, void * ap_str, unint16_t a_size)
{
...
void uart_read_str(unint8_t a_uart_no, void * ap_str)
{
	uart_read_until(a_uart_no, ap_str, 0);
}
